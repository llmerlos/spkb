...
enum keycode_spec {
	...
	KP_NLCK	= 0x53,	/* KP_ NumLock or Clear */
	KP_SLSH	= 0x54,	/* KP_ / */
	KP_ASTX	= 0x55,	/* KP_ * */
	KP_MINS	= 0x56,	/* KP_ - */
	KP_PLUS	= 0x57,	/* KP_ + */
	KP_ENTR	= 0x58,	/* KP_ Enter */
	KP_1	= 0x59,	/* KP_ 1 or End */
	KP_2	= 0x5A,	/* KP_ 2 or Down Arrow */
	KP_3	= 0x5B,	/* KP_ 3 or Page Down */
	KP_4	= 0x5C,	/* KP_ 4 or Left Arrow */
	KP_5	= 0x5D,	/* KP_ 5 */
	KP_6	= 0x5E,	/* KP_ 6 or Right Arrow */
	KP_7	= 0x5F,	/* KP_ 7 or Home */
	KP_8	= 0x60,	/* KP_ 8 or Up Arrow */
	KP_9	= 0x61,	/* KP_ 9 or Page Up */
	KP_0	= 0x62,	/* KP_ 0 or Insert */
	KP_PERD	= 0x63,	/* KP_ . or Delete */
	...
	KP_CMMA	= 0x85,	/* KP_ Comma */
	KP_EQAS	= 0x86,	/* KP_ Equal Sign for AS/400 */
